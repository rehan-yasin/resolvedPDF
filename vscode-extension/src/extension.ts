            ...
            () => new Promise<void>((resolve) => {
                ...
                proc.on('close', (code: number) => {
                    ...
                    if (code === 0 && fs.existsSync(outputPath)) {
                        ...
                        const currentCount = context.globalState.get<number>('conversionCount', 0);
                        ...
                        if (newCount === 10) {
                            vscode.window.showInformationMessage(
                                "🎉 You've converted 10 PDFs with ResolvedPDF! If you're enjoying it, a quick 5-star review would mean the world to me.",
                                "Leave a Review",
                                "Remind me later"
                            ).then(selection => {
